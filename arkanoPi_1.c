...
int CompruebaTeclaPulsada(fsm_t* this) {
	...
	piLock(FLAGS_KEY);
	result1 = (flags & FLAG_RAQUETA_IZQUIERDA);
	result2 = (flags & FLAG_RAQUETA_DERECHA);
...
//Acci髇 a realizar cuando se arranca el timer
...
int main () {
	...
	//Configuraci髇 e inicalizaci髇 del sistema
	systemSetup();
